...
Sendmail installations using clamav-milter versions below 0.91.2 are vulnerable to remote code execution. Attackers can exploit this by sending specially crafted emails, allowing them to execute arbitrary code with the privileges of the Sendmail process. This could lead to unauthorized access, data manipulation, or further exploitation of the server.

### **Vulnerability Fix:** 

#### Sendmail with clamav-milter < 0.91.2 -Remote Code Execution Exploit

Update clamav-milter to version 0.91.2 or later to mitigate this vulnerability. Ensure that all Sendmail-related services are regularly patched, and restrict network access to Sendmail to limit potential attackers’ reach.
